...
// Row 0
pub fn tile_grass_top() -> TileUV {
    TileUV::new_top(0, 0)
}
pub fn tile_grass_side() -> TileUV {
    TileUV::new(1, 0)
}
pub fn tile_dirt() -> TileUV {
    TileUV::new(3, 0)
}
pub fn tile_stone() -> TileUV {
    TileUV::new(4, 0)
}
pub fn tile_sand() -> TileUV {
    TileUV::new(5, 0)
}
pub fn tile_gravel() -> TileUV {
    TileUV::new(6, 0)
}
pub fn tile_snow() -> TileUV {
    TileUV::new(7, 0)
}
pub fn tile_cobblestone() -> TileUV {
    TileUV::new(8, 0)
}
pub fn tile_bedrock() -> TileUV {
    TileUV::new(9, 0)
}
pub fn tile_water() -> TileUV {
    TileUV::new(10, 0)
}
pub fn tile_water_flow() -> TileUV {
    TileUV::new(11, 0)
}
pub fn tile_tree_trunk_side() -> TileUV {
    TileUV::new(12, 0)
} // oak_log.png
pub fn tile_tree_trunk_top() -> TileUV {
    TileUV::new_top(13, 0)
} // oak_log_top.png
pub fn tile_tree_leaves() -> TileUV {
    TileUV::new(14, 0)
} // oak_leaves.png
pub fn tile_lava_still() -> TileUV {
    TileUV::new(15, 0)
}
pub fn tile_lava_flow() -> TileUV {
    TileUV::new(16, 0)
}

// Row 1
pub fn tile_coal_ore() -> TileUV {
    TileUV::new(0, 1)
}
pub fn tile_iron_ore() -> TileUV {
    TileUV::new(1, 1)
}
pub fn tile_gold_ore() -> TileUV {
    TileUV::new(2, 1)
}
pub fn tile_diamond_ore() -> TileUV {
    TileUV::new(3, 1)
}
pub fn tile_emerald_ore() -> TileUV {
    TileUV::new(4, 1)
}
pub fn tile_redstone_ore() -> TileUV {
    TileUV::new(5, 1)
}
pub fn tile_copper_ore() -> TileUV {
    TileUV::new(6, 1)
}
pub fn tile_lapis_ore() -> TileUV {
    TileUV::new(7, 1)
}
pub fn tile_stone_bricks() -> TileUV {
    TileUV::new(8, 1)
}
pub fn tile_andesite() -> TileUV {
    TileUV::new(11, 1)
}
pub fn tile_granite() -> TileUV {
    TileUV::new(12, 1)
}
pub fn tile_diorite() -> TileUV {
    TileUV::new(13, 1)
}
pub fn tile_nether_rock() -> TileUV {
    TileUV::new(14, 1)
} // netherrack.png
pub fn tile_glow_rock() -> TileUV {
    TileUV::new(15, 1)
} // glowstone.png

// Row 2
pub fn tile_slate_rock() -> TileUV {
    TileUV::new(0, 2)
} // deepslate.png
pub fn tile_slate_coal_ore() -> TileUV {
    TileUV::new(1, 2)
} // deepslate_coal_ore.png
pub fn tile_deepslate_iron_ore() -> TileUV {
    TileUV::new(2, 2)
}
pub fn tile_deepslate_copper_ore() -> TileUV {
    TileUV::new(3, 2)
}
pub fn tile_deepslate_gold_ore() -> TileUV {
    TileUV::new(4, 2)
}
pub fn tile_slate_diamond_ore() -> TileUV {
    TileUV::new(5, 2)
} // deepslate_diamond_ore.png
pub fn tile_deepslate_emerald() -> TileUV {
    TileUV::new(6, 2)
}
pub fn tile_deepslate_lapis() -> TileUV {
    TileUV::new(7, 2)
}
pub fn tile_deepslate_redstone() -> TileUV {
    TileUV::new(8, 2)
}
pub fn tile_deepslate_bricks() -> TileUV {
    TileUV::new(9, 2)
}
pub fn tile_tuff() -> TileUV {
    TileUV::new(10, 2)
}
pub fn tile_tuff_bricks() -> TileUV {
    TileUV::new(11, 2)
}
pub fn tile_obsidian() -> TileUV {
    TileUV::new(12, 2)
}
pub fn tile_crying_obsidian() -> TileUV {
    TileUV::new(13, 2)
}
pub fn tile_end_stone() -> TileUV {
    TileUV::new(14, 2)
}
pub fn tile_end_stone_bricks() -> TileUV {
    TileUV::new(15, 2)
}

// Row 3
pub fn tile_oak_planks() -> TileUV {
    TileUV::new(0, 3)
}
pub fn tile_spruce_log_side() -> TileUV {
    TileUV::new(1, 3)
}
pub fn tile_birch_log_side() -> TileUV {
    TileUV::new(2, 3)
}
pub fn tile_jungle_log_side() -> TileUV {
    TileUV::new(3, 3)
}
pub fn tile_acacia_log_side() -> TileUV {
    TileUV::new(4, 3)
}
pub fn tile_dark_oak_log_side() -> TileUV {
    TileUV::new(5, 3)
}
pub fn tile_mangrove_log_side() -> TileUV {
    TileUV::new(6, 3)
}
pub fn tile_pale_oak_log_side() -> TileUV {
    TileUV::new(7, 3)
}
pub fn tile_spruce_leaves() -> TileUV {
    TileUV::new(8, 3)
}
pub fn tile_birch_leaves() -> TileUV {
    TileUV::new(9, 3)
}
pub fn tile_jungle_leaves() -> TileUV {
    TileUV::new(10, 3)
}
pub fn tile_acacia_leaves() -> TileUV {
    TileUV::new(11, 3)
}
pub fn tile_dark_oak_leaves() -> TileUV {
    TileUV::new(12, 3)
}
pub fn tile_mangrove_leaves() -> TileUV {
    TileUV::new(13, 3)
}
pub fn tile_pale_oak_leaves() -> TileUV {
    TileUV::new(14, 3)
}
pub fn tile_azalea_leaves() -> TileUV {
    TileUV::new(15, 3)
}

// Row 4
pub fn tile_clay() -> TileUV {
    TileUV::new(0, 4)
}
pub fn tile_mycelium() -> TileUV {
    TileUV::new_top(1, 4)
}
pub fn tile_podzol() -> TileUV {
    TileUV::new_top(2, 4)
}
pub fn tile_rooted_dirt() -> TileUV {
    TileUV::new(3, 4)
}
pub fn tile_moss_block() -> TileUV {
    TileUV::new(4, 4)
}
pub fn tile_mud() -> TileUV {
    TileUV::new(5, 4)
}
pub fn tile_packed_mud() -> TileUV {
    TileUV::new(6, 4)
}
pub fn tile_muddy_mangrove_roots() -> TileUV {
    TileUV::new_top(7, 4)
}
pub fn tile_coarse_dirt() -> TileUV {
    TileUV::new(8, 4)
}
pub fn tile_farmland() -> TileUV {
    TileUV::new(9, 4)
}
pub fn tile_farmland_moist() -> TileUV {
    TileUV::new(10, 4)
}
pub fn tile_soul_sand() -> TileUV {
    TileUV::new(11, 4)
}
pub fn tile_soul_soil() -> TileUV {
    TileUV::new(12, 4)
}
pub fn tile_nether_wart_block() -> TileUV {
    TileUV::new(13, 4)
}
pub fn tile_warped_wart_block() -> TileUV {
    TileUV::new(14, 4)
}
pub fn tile_shroomlight() -> TileUV {
    TileUV::new(15, 4)
}

// Row 5 — vegetation decoration
pub fn tile_bush() -> TileUV {
    TileUV::new(0, 5)
} // bush.png
pub fn tile_tall_grass() -> TileUV {
    TileUV::new(1, 5)
} // short_grass.png
pub fn tile_flower() -> TileUV {
    TileUV::new(2, 5)
} // dandelion.png
pub fn tile_dead_bush() -> TileUV {
    TileUV::new(3, 5)
} // dead_bush.png
pub fn tile_cactus_side() -> TileUV {
    TileUV::new(4, 5)
} // cactus_side.png
pub fn tile_cactus_top() -> TileUV {
    TileUV::new_top(5, 5)
} // cactus_top.png
pub fn tile_deer_fur() -> TileUV {
    TileUV::new(6, 5)
} // procedural fur
...
mod tests {
    ...
    fn compose_from_blocks_is_fully_procedural_after_asset_removal() {
        ...
        let b = crate::world::ai_generator::generate_tile_texture(
            p,
            pat,
            crate::world::ai_generator::name_seed("stone"),
        );
        ...
        let s2 = crate::world::ai_generator::generate_tile_texture(
            log_p,
            log_pat,
            crate::world::ai_generator::name_seed("oak_log"),
        );
